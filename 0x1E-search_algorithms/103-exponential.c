...
/**
 * min - return minimum of two size_t values
 * @a: first value
 * @b: second value
...
/**
 * binary_search_helper - search value in integer array using
...
/**
 * exponential_search - search value in a sorted array of integers
